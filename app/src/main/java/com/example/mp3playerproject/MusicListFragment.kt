...
import com.example.mp3playerproject.databinding.FragmentMusicListBinding
...
class MusicListFragment : Fragment() {
    ...
    fun refreshItem() {
        ...
        val musicList = dbOpenHelper.selectAllMusicTBL()
        binding.recyclerView.layoutManager = LinearLayoutManager(mainActivity)
        binding.recyclerView.adapter = MusicRecyclerAdapter(mainActivity,musicList)
    }
}